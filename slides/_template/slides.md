...
<div class="flex gap-8 mt-4">
  <div class="flex-1">
    <p class="font-bold">💡 ARCHITECTURE_SUBTITLE</p>
...
<div class="mt-4 grid grid-cols-3 gap-6 text-base">
  ...
  <div>
    <p class="font-bold">TECH_CATEGORY_2</p>
    <ul class="mt-2 space-y-1 list-disc list-inside">
      <li>TECH_4</li>
      <li>TECH_5</li>
    </ul>
  ...
  <div>
    <p class="font-bold">TECH_CATEGORY_3</p>
    <ul class="mt-2 space-y-1 list-disc list-inside">
      <li>TECH_6</li>
    </ul>
  </div>
...
<div class="absolute bottom-8 left-8">
  <p class="text-xl">CLOSING_MESSAGE</p>
</div>
